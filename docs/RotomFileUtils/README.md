...
Arquivo: `src/main/java/io/github/sidneyroberto9/rotom/io/RotomFileUtils.java`
...
```java
RotomFileUtils fileUtils = new RotomFileUtils();
```

## Bean Spring

Com `RotomAutoConfiguration` ativo, um bean `RotomFileUtils` fica disponível para injeção.
