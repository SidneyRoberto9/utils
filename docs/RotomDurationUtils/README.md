...
Arquivo: `src/main/java/io/github/sidneyroberto9/rotom/date/RotomDurationUtils.java`
...
```java
RotomDurationUtils durationUtils = new RotomDurationUtils();
```

## Bean Spring

Com `RotomAutoConfiguration` ativo, um bean `RotomDurationUtils` fica disponível para injeção.
