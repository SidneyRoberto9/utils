...
Arquivo: `src/main/java/io/github/sidneyroberto9/rotom/cep/domain/RotomCepService.java`
...
Com `RotomAutoConfiguration` ativo, um bean `RotomCepService` (construído com `new RotomCepService()`,
