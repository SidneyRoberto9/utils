...
Arquivo: `src/main/java/io/github/sidneyroberto9/rotom/phoneNumber/RotomPhoneNumberService.java`
...
Com `RotomAutoConfiguration` ativo, um bean `RotomPhoneNumberService` fica disponível para injeção.
