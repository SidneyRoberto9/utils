...
Arquivo: `src/main/java/io/github/sidneyroberto9/rotom/strings/RotomStringUtils.java`
...
Com `RotomAutoConfiguration` ativo, um bean `RotomStringUtils` fica disponível para injeção.
