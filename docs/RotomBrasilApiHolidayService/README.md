# RotomBrasilApiHolidayService

Pacote: `io.github.sidneyroberto9.rotom.date.holiday`
Arquivo: `src/main/java/io/github/sidneyroberto9/rotom/date/holiday/RotomBrasilApiHolidayService.java`
...
> Diferente de [`RotomDateService`](../RotomDateService/README.md), que usa o calendário offline **jollyday**
...
```java
RotomBrasilApiHolidayService holidayService = new RotomBrasilApiHolidayService();
```

## Bean Spring

Com `RotomAutoConfiguration` ativo, um bean `RotomBrasilApiHolidayService` fica disponível para
injeção.
