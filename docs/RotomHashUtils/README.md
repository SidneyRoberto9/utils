...
Arquivo: `src/main/java/io/github/sidneyroberto9/rotom/hash/RotomHashUtils.java`
...
Com `RotomAutoConfiguration` ativo, um bean `RotomHashUtils` fica disponível para injeção.
