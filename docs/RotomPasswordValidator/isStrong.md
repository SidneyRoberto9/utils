# RotomPasswordValidator.isStrong(String password)

**Pacote:** `io.github.sidneyroberto9.rotom.validation`
**Arquivo:** `RotomPasswordValidator.java`
...
- Regex copiado fielmente do `RotomPasswordValidator` original do m4all, incluindo a classe de
